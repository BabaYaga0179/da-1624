...
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/custom_package_items.conf -O custom_package_items.conf
chown diradmin. custom_package_items.conf
chmod 700 custom_package_items.conf
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/custom_domain_items.conf -O custom_domain_items.conf
chown diradmin. custom_domain_items.conf
chmod 700 custom_domain_items.conf
cd /usr/local/directadmin/scripts/custom
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/user_create_post.sh -O user_create_post.sh
chown diradmin.diradmin user_create_post.sh
chmod 700 user_create_post.sh
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/domain_create_post.sh -O domain_create_post.sh
chown diradmin.diradmin domain_create_post.sh
chmod 700 domain_create_post.sh
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/domain_modify_post.sh -O domain_modify_post.sh
chown diradmin.diradmin domain_modify_post.sh
chmod 700 domain_modify_post.sh
wget --no-check-certificate https://da.wptop.net/services/custombuild/install-wp/subdomain_create_post.sh -O subdomain_create_post.sh
